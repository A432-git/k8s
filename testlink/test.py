...
newAttachment = myTestLink.uploadTestCaseAttachment(a_file, newTestCaseID_B, 1,
                                                    title='PNG Example v1',
                                                    description='PNG Attachment Example for a TestCase v1')
...
newAttachment = myTestLink.uploadTestCaseAttachment(a_file, newTestCaseID_B, 2,
                                                    title='Textfile Example v2',
                                                    description='Text Attachment Example for a TestCase v2')
